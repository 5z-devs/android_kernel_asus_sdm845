...
enum Tfa98xx_Error {
	Tfa98xx_Error_Ok = 0,
	Tfa98xx_Error_Device,	        /* 1. Currently only used to keep in sync with Tfa98xx_Error */
	Tfa98xx_Error_Bad_Parameter,	/* 2. parameter no accepted */
	Tfa98xx_Error_Fail,             /* 3. generic failure, avoid mislead message */
	Tfa98xx_Error_NoClock,          /* 4. no clock detected */
	Tfa98xx_Error_StateTimedOut,	/* 5. a timeout occurred */
